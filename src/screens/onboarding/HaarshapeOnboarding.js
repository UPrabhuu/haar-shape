...
const slide1Img = require('../../assets/img/HSonboarding_1.png');
const slide2Img = require('../../assets/img/HSonboarding_2.png');
const slide3Img = require('../../assets/img/HSonboarding_3.png');
const slide4Img = require('../../assets/img/HSonboarding_4.png');
...
const slides = [
  {
    ...
    description:
      'Easy and fast way to book appointment from the best local salon.',
  },
  {
    id: 'slide2',
    img: slide2Img,
    title: 'Choose your Style',
    description: 'Browse through menu and reviews to find the best you like.',
  },
  {
    id: 'slide3',
    img: slide3Img,
  ...
  },
  {
    ...
    img: slide4Img,
    title: 'Get Fast',
    description: 'Get Ticket to your mobile in minutes. Save Time, you enjoy!',
  },
];
...
// OnboardingB
export default class HarshapeOnboarding extends Component {
  constructor(props) {
    super(props);
    this.state = {
      activeIndex: 0,
